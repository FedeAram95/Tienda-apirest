...
@Service(value = "cancelarOperacionSender")
public class NotificationCancelarOperacionSender extends NotificationSender {

    public NotificationCancelarOperacionSender(String magicBellApiKey, String magicBellApiSecret) {
    ...
    public Notification doBuild(String title, Object helper, String actionUrl, String user) {
        ...
        String content = "Cancelaste tu compra con N° " + nroOperacion;
